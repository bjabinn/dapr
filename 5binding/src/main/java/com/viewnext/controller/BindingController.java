...
import com.viewnext.controller.models.Order;
import com.viewnext.controller.models.Orders;
    ...
    public ResponseEntity<String> processBatch() throws Exception {
        ...
        try (DaprClient client = new DaprClientBuilder().build()) {
            for (Order order : ordList.orders) {
                String sqlText = String.format("INSERT INTO orders (orderid, customer, price) " +
                                               "VALUES (%s, '%s', %s);",
